  ...
  return(
    <nav style={headerStyle} className="header-navbar">
      ...
      Logged in as {props.email} | &nbsp;
        <button className="fake-link" onClick={props.logout}>(Log out)</button><Image className="profile-icon" circular src="https://react.semantic-ui.com/images/avatar/large/patrick.png">
      </p>
